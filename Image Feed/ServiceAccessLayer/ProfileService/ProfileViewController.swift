...
final class ProfileViewController: UIViewController, ProfileViewControllerProtocol {
    ...
    private lazy var nameLabel: UILabel = {
        ...
        label.accessibilityIdentifier = "ProfileName" // 👈 для UI-тестов
        label.isAccessibilityElement = true // 👈 делаем элементом доступности
        return label
    }()
    ...
    func showLogoutConfiguration() {
        ...
        // Кнопка "Да" как во втором контроллере — style: .default
        alert.addAction(
    ...
    private func setupUI() {
        ...
        [profilePhotoImageView, nameLabel, loginNameLabel, descriptionLabel, logoutButton]
